...
const STEP_COLORS = {
  light: { bubbleActive: '#039f5d', bubbleIdle: '#d6e6dc', onBubble: '#ffffff', idleIcon: '#5c7285', success: '#0D6E0D' },
  dark: { bubbleActive: '#ffd25a', bubbleIdle: '#2d5f4a', onBubble: '#163a28', idleIcon: '#93bdaa', success: '#4ade80' },
};
